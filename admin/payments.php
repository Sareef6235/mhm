...
<main class="main">
    <header class="topbar">
        <div>
            <div class="breadcrumb-line">Admin / Payments</div>
            <h1>Payments</h1>
    ...
    <section class="table-card lift">
        <div class="d-flex justify-content-between align-items-start gap-3 flex-wrap mb-4">
            <div><p class="page-kicker mb-1">Management</p><h2 class="h3 fw-black mb-0">Payments control center</h2></div>
        ...
        <div class="input-icon mb-4"><i class="bi bi-search"></i><input class="form-control search-input" placeholder="Search Payments records"></div>
        <div class="table-responsive">
            <table class="table align-middle"><thead><tr><th>Name</th><th>Status</th><th>Updated</th><th class="text-end">Action</th></tr></thead><tbody><tr><td><b>Premium Payments Item</b><div class="text-muted small">Configured from admin settings</div></td><td><span class="badge-soft-success">Active</span></td><td>Today</td><td class="text-end"><button class="btn btn-sm btn-outline-primary">Manage</button></td></tr></tbody></table>
        </div>
    </section>
</main>
