<header class="bg-white rounded-2xl shadow-sm p-4">
  ...
  <p class="text-sm"><?= h($student['name']) ?> · <?= h($student['class_name']) ?></p>
</header>

<?php if ($message): ?><div class="bg-emerald-100 text-emerald-700 rounded-xl p-3 text-sm"><?= h($message) ?></div><?php endif; ?>
