...
<div class="agum-form-grid">
	...
	<label>Profile Photo<input name="profile_photo_file" type="file" accept=".jpg,.jpeg,.png,.webp,image/jpeg,image/png,image/webp" required></label>
	<label>Image Path<input name="image_path" type="url" readonly required placeholder="Auto-filled after image validation"></label>
	<label>Profile Photo URL<input name="profile_photo" type="url" readonly required placeholder="Auto-filled after image validation"></label>
</div>
